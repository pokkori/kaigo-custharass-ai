    ...
    <div>
      {showAnnualToggle && (
        <div className="flex gap-2 mb-3">
          ...
          >
            <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 bg-green-500 text-white text-xs px-2 py-0.5 rounded-full whitespace-nowrap leading-tight">
              2ヶ月分お得
            </div>
      ...
      <button
        ...
        className={
          className ??
          "w-full bg-teal-600 text-white font-bold py-3 rounded-xl hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        }
      >
        {loading
          ? "決済ページへ移動中..."
