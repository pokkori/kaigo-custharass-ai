...
const TOOLS = [
  { name: '介護ヒヤリハットAI', desc: '介護現場のヒヤリハット報告書をAI生成', url: 'https://kaigo-hiyarihatto-ai.vercel.app', category: 'care' },
  { name: '介護記録AI書記', desc: '介護記録・申し送りをAI自動作成', url: 'https://kaigo-kiroku-ai.vercel.app', category: 'care' },
  { name: '医療ヒヤリハットAI', desc: '医療現場のインシデント報告をAI生成', url: 'https://iryou-hiyarihatto-ai.vercel.app', category: 'care' },
  { name: '就業規則AI', desc: '就業規則・規程をAI自動作成', url: 'https://shugyo-kisoku-ai.vercel.app', category: 'business' },
  { name: 'HR求人票AI', desc: '採用要件に合わせた求人票をAI生成', url: 'https://hr-kyujin-ai.vercel.app', category: 'business' },
  { name: '点呼記録AI', desc: '運行前点呼記録をAI自動作成', url: 'https://tencho-kiroku-ai.vercel.app', category: 'business' },
  { name: '補助金申請書AI', desc: '補助金申請書類をAI自動生成', url: 'https://hojyokin-shinsho-ai.vercel.app', category: 'business' },
  { name: '建設書類AI', desc: '建設業の書類をAI自動作成', url: 'https://kensetsu-shorui-ai.vercel.app', category: 'business' },
  { name: '建設安全書類AI', desc: '建設現場の安全書類をAI生成', url: 'https://kensetsu-anzen-ai.vercel.app', category: 'business' },
  { name: '製造業ヒヤリハットAI', desc: '製造現場のヒヤリハット報告をAI生成', url: 'https://seizogyo-hiyarihatto-ai.vercel.app', category: 'business' },
  ...
  { name: '介護カスハラAI', desc: '介護現場の対応文を生成', url: 'https://kaigo-custharass-ai.vercel.app', category: 'care' },
